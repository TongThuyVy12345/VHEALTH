...
from VHealth.model.admin import UserView, QuestionView, AnswerView, CategoryView, MBTIView, HollandView, \
    QuestionAnswerView, ExecriseView
    ...
    if mess:
        ...
        if (index >= max_index):
            if(max_score==total_scoreA):
                content_max="Chào bạn, chào mừng bạn đến với trắc nghiệm nghề nghiệp Holland.Đầu tiên cảm ơn bạn đã tham gia thử nghiệm trắc nghiệm. Kết quả của bạn sẽ được trả chi tiết ngay sau đây: BẢNG A: " \
                            "Realistic - Người thực tế. Người thuộc nhóm sở thích nghề nghiệp này thường có khả năng về: kỹ thuật, công nghệ, hệ thống; ưa thích làm việc với đồ vật, máy móc, động thực vật; thích làm các công việc ngoài trời. Ngành nghề phù hợp với nhóm này bao gồm: Các nghề về kiến trúc, an toàn lao động, nghề mộc, xây dựng, thủy  sản, kỹ thuật, máy tàu thủy, lái xe, huấn luyện viên, nông – lâm nghiệp (quản lý trang trại, nhân giống cá, lâm nghiệp…), cơ khí (chế tạo máy, bảo trì và sữa chữa thiết bị, luyện kim, cơ khí ứng dụng, tự động...), điện - điện tử, địa lý - địa chất (đo đạc, vẽ bản đồ địa chính), dầu khí, hải dương học, quản lý công nghiệp.."
            elif (max_score == total_scoreB):
                content_max = "Chào bạn, chào mừng bạn đến với trắc nghiệm nghề nghiệp Holland. Đầu tiên cảm ơn bạn đã tham gia thử nghiệm trắc nghiệm. Kết quả của bạn sẽ được trả chi tiết ngay sau đây:BẢNG B: Investigative - Người nghiên cứu.Có khả năng về: quan sát, khám phá, phân tích đánh giá và giải quyết các vấn đề. Ngành nghề phù hợp với nhóm này bao gồm: Các ngành thuộc lĩnh vực khoa học tự nhiên (toán, lý, hóa, sinh, địa lý, địa chất, thống kê…); khoa học xã hội (nhân học, tâm lý, địa lý…); y - dược (bác sĩ gây mê, hồi sức, bác sĩ phẫu thuật, nha sĩ…); khoa học công nghệ (công nghệ thông tin, môi trường, điện, vật lý kỹ thuật, xây dựng…); nông lâm (nông học, thú y…)"

            elif (max_score == total_scoreC):
                content_max = "Chào bạn, chào mừng bạn đến với trắc nghiệm nghề nghiệp Holland. Đầu tiên cảm ơn bạn đã tham gia thử nghiệm trắc nghiệm. Kết quả của bạn sẽ được trả chi tiết ngay sau đây:BẢNG C: Artistic - Người có tính nghệ sĩ.Có khả năng về: nghệ thuật, khả năng về trực giác, khả năng tưởng tượng cao, thích làm việc trong các môi trườn mang tính ngẫu hứng, không khuôn mẫu.Ngành nghề phù hợp với nhóm này bao gồm: Các ngành về văn chương; báo chí (bình luận viên, dẫn chương trình…); điện ảnh, sân khấu, mỹ thuật, ca nhạc, múa, kiến trúc, thời trang, hội họa, giáo  viên dạy sử/Anh văn, bảo tàng, bảo tồn..."
            elif (max_score == total_scoreD):
                content_max = "Chào bạn, chào mừng bạn đến với trắc nghiệm nghề nghiệp Holland. Đầu tiên cảm ơn bạn đã tham gia thử nghiệm trắc nghiệm. Kết quả của bạn sẽ được trả chi tiết ngay sau đây:BẢNG D: Social - Người có tính xã hội.Có khả năng về: ngôn ngữ, giảng giải, thích làm những việc như giảng dạy, cung cấp thông tin, sự chăm sóc, giúp  đỡ, hoặc huấn luyện cho người khác. Ngành nghề phù hợp với nhóm này bao gồm: sư phạm;  giảng viên; huấn luyện viên điền kinh; tư vấn - hướng nghiệp; công tác xã hội, sức khỏe cộng đồng, thuyền  trưởng, thầy tu, thư viện, bác sĩ chuyên khoa, thẩm định giá, nghiên cứu quy hoạch đô thị, kinh tế gia đình, tuyển dụng nhân sự, cảnh sát, xã hội học, bà đỡ, chuyên gia về Xquang, chuyên gia dinh dưỡng…"
            elif (max_score == total_scoreE):
                content_max = "Chào bạn, chào mừng bạn đến với trắc nghiệm nghề nghiệp Holland. Đầu tiên cảm ơn bạn đã tham gia thử nghiệm trắc nghiệm. Kết quả của bạn sẽ được trả chi tiết ngay sau đây:BẢNG E: Enterprising - Dám nghĩ, dám làm.Có khả năng về: kinh doanh, mạnh bạo, dám nghĩ dám làm, có thể gây ảnh hưởng, thuyết phục Người khác, có khả năng quản lý.Ngành nghề phù hợp với nhóm này bao gồm: Các ngành về quản trị kinh doanh (quản lý khách sạn, quản trị nhân sự,…), thương mại, marketing, kế toán – tài chính, luật sư, dịch vụ khách hàng, tiếp viên hàng không, thông dịch viên, pha chế rượu, kỹ sư công nghiệp (ngành kỹ thuật hệ thống công nghiệp), bác sĩ cấp cứu, quy hoạch đô thị, bếp trưởng (nấu ăn), báo chí (phóng viên, biên tập viên…)"
                ...
                content_max = "Chào bạn, chào mừng bạn đến với trắc nghiệm nghề nghiệp Holland. Đầu tiên cảm ơn bạn đã tham gia thử nghiệm trắc nghiệm. Kết quả của bạn sẽ được trả chi tiết ngay sau đây:" \
                                              "BẢNG F: Conventional - Người công chức.Có khả năng về: số học, thích thực hiện những công việc chi tiết, thích làm việc với những số liệu,  theo chỉ dẫn của người khác hoặc các công việc văn phòng. Ngành nghề phù hợp với nhóm này bao gồm: Các ngành nghề về hành chính, thống kê, thanh tra ngành, người giữ trẻ, điện thoại viên..."
            return jsonify({'success': True, 'mess':mess,'testquestion':content_max,'c1':'Chưa bao giờ đúng','c2':'Đúng trong 1 vài trường hợp','c3':'Đúng trong đa số các trường hợp','c4':'Đúng trong tất cả trường hợp'}), 200
        index += 1
        question = df.iloc[index]['Question']
        session.clear()
        session["index"] = index
    return jsonify({'success': True, 'mess':mess,'testquestion':question,'c1':'Chưa bao giờ đúng','c2':'Đúng trong 1 vài trường hợp','c3':'Đúng trong đa số các trường hợp','c4':'Đúng trong tất cả trường hợp'}), 200
...
# 
#         db['User'].insert_one(
#             {"password": hashed_password, "email": email, "fullname": fullname, "gender": gender, "issuperuser": 1,
